...
int maxNodeVal(TreeNode* root) {
    //keep going right untill nullptr
...
TreeNode* deleteNode(TreeNode* root, int key) {
    ...
    {   //key == root 
        ...
        //has both children: find max of left subtree (which should be a leaf) replace and delete that recursively
        int leftMax = maxNodeVal(root -> left);
        root -> val = leftMax;
